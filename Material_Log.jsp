...
<%@page import="com.tvs.version.Material"%>
<%@page import="com.tvs.version.MaterialDAO"%>
...
try
{
	List<Material> listal=m.alllist();
...
<div class = "panel panel-primary">
  ...
  <table class="table borderless"  >
    <thead>
    <tbody>
       <tr align="left" id="filter_col1" data-column="5">
 ...
 <input type="text" id="min-date" size=10  class=" date-range-filter"  data-date-format="yyyy-mm-dd" > <strong>To</strong>
		<input type="text" id="max-date" size=10 class="date-range-filter" data-date-format="yyyy-mm-dd" >
		   ...
		   <td  style="font-weight:bold" align="left" width="1%" > UserId</td>
				<td><input autocomplete="off" type="text" size=10 class="column_filter" id="col5_filter"></td>
      </tr>
    </tbody>
  </table>
