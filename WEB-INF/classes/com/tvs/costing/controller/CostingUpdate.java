...
@WebServlet("/Costingupdate")
public class CostingUpdate extends HttpServlet {
	...
	//		Integer valuationclasscode = Integer.parseInt(valuationclasscode1);
	...
	//		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
	//		System.out.println(valuationcat);
	//
	...
	//		}
			...
			int status=CostingDAO.Update(s);
			if(stus.equals("Inactive") )
			{
				stus="Submit";
				s.setStatus(stus);
			    int sss=CostingDAO.insertaudits(s);
