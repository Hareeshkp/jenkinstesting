...
<h5 style="margin-top:2%;margin-left:30%;">! Your Password Has Expired and Must Be Changed.</h5>
  <a href="logout" style="margin-top:2%;margin-left:70%;"  class="btn btn-danger" role="button">Logout</a>


<form   name="form" action="Passwords" method="post"  onsubmit="return checkForm(this);" >
	<div id="user" class="row" style="margin-top:2%;margin-left:20%;">
		...
		<div class = "panel panel-primary">
   		...
   		<div class="col-md-12">
		    ...
		    <div class="form-group ">
		      ...
		      <input type="password" list="PlantList"   pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,12}$"  title="a combination of alpha, numeric and special character between 8 to 12"    autocomplete="off" class="form-control input-sm " name="password"  id="password" placeholder="Password"required autocomplete="off" o >
