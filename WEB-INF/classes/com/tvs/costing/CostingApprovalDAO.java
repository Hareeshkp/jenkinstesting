...
public class CostingApprovalDAO {
	public static int Update(CostingApproval e){  
        int status=0;  
        	Connection con=null;
	        PreparedStatement ps=null;        
        try{  
        	 con=ETLConnection.getConnection();
             ps=con.prepareStatement("Update  \"STG_SCR_Costing_Accounting\" set \"Approved_By\" =?,\"Approved_Date\"=?,\"Approval_Status\"=?,\"Reject_Reason\"=? where \"MDM_Code\"=? and \"Plant_Code\"=? ");  
	 ...
	 public static int insertaudit(CostingApproval e){  
		    int status=0;  
		    Connection con=null;
		    PreparedStatement ps=null;
		    try
