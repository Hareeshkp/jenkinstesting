...
String distc=request.getParameter("distc");
...
try
{
List<Sales> listal = sd.UserList1(username,mattyp,plantv,distc,status,apvstatus,version);
	...
	<thead>
	   ...
	   <tbody>
	    ...
	    <tr>
	    	...
	    	<td><a  href='SalesEdit.jsp?id=${abcd.mdmcode}&amp;plant=${abcd.plantcode}&amp;dcode=${abcd.dtchcode}' style="text-decoration:underline;"
