...
<c:set var="myTest" scope="request" value="${sessionScope.userid}"/>
	...
	//String polymercode1 = r.getvolumeunitcode();
	//String polymervalue1 = r.getvolumeunitdesc();
...
<form action="SCRBasicUpdate" id="fm1" method="post">
  ...
  <div class = "panel-heading">
      <h3 class = "panel-title">Basic & Plant Mapping View</h3>
	   ...
	   <div class = "panel-body">
   		<div class="col-md-12">
		  <fieldset>
		 	<legend class="w-auto">Basic View</legend> 
		  </fieldset> 
  		</div>  
	   <div class="col-md-6">
	    ...
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "-1" class="materialcode form-control input-sm" onkeypress="return isNumber(event)" maxlength="40"   value="${mc }" id="MaterialCode" name="MaterialCode"  placeholder="Material Code" autocomplete="off" 
	        <c:if test="${status eq 'Active' }"> readonly </c:if>
	        >                  
	      </div>
	    </div>
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "-1" list="BasicUom" class="form-control input-sm" maxlength="40"  value="${budesc }" id="basicuom" placeholder="Basic UOM" name="basicuom" onchange="return basicuoms();" onfocusout="BasicUOMFun()"
	        <c:if test="${status eq 'Active' }"> readonly </c:if>
	        required>  
	    ...
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "-1" class="form-control input-sm" 
	    ...
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "1" class="form-control input-sm" id="GrossWeight" 
	          <c:choose>
	    ...
	    <div class="form-group ">
	      <label class="required control-label col-sm-4" for="email">HSN Code</label>
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex="-1" class="form-control input-sm" onkeypress="return isNumber(event)" value="${hsn}" maxlength="16"  id="HSNCode"  placeholder="HSN Code" name="HSNCode" autocomplete="off" 
	        <c:if test="${status eq 'Active' }"> readonly </c:if>
	        >        
	      </div>
	    </div>
	     <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex="-1" class="form-control input-sm" value="${volume}" maxlength="16"  id="Volume"  placeholder="Volume" name="Volume" autocomplete="off" >        
	      </div>
	    </div>
	    ...
	    >
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="checkbox" tabindex = "4" class="input-sm" name="block" value="${blck}" id="block"  onclick="calc();">        
	      </div>
	    </div>
	    <div class="form-group " <c:if test="${status eq 'Draft'}"> style='display:none;' </c:if> <c:if test="${appstus eq 'Rejected'}"> style='display:none;' </c:if>
	    >
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "6" class="form-control input-sm" maxlength="250"  onkeypress="return onlyAlphabets(event,this);" maxlength="30"  id="reasonforedit"  placeholder="Reason for Edit"  <c:if test="${status eq 'Active' }"> required </c:if> name="reasonforedit" autocomplete="off">        
	      </div>
	    </div>
	   </div>
	   ...
	   <div class="col-md-6">
	    ...
	    <div class="form-group ">
	     ...
	     <!--  <a href="#" >LaunchScreen</a>--> 
	      <input type="button" tabindex = "-1" id="asd" class="btn btn-primary <c:if test="${status eq 'Active'}" > disabled </c:if>" disabled onclick="LaunchS()"  value="LaunchScreen"
	      <c:if test="${status eq 'Active' }"> readonly </c:if>
	      >	                
	      </div>
	    </div>
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "-1" readonly class="form-control input-sm" value="${fn:replace(desc, '"', '&quot;')}" maxlength="40"  required id="Description" placeholder="Description" name="Description" autocomplete="off"
	        <c:if test="${status eq 'Active' }"> readonly </c:if>
	        >        
	      </div>
	    </div>
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "-1" list="AlterUOM" class="form-control input-sm" maxlength="40" value="${AlterUomdesc}" id="AlterNativeUOM" onchange="return altuom()" placeholder="Alternative UOM" name="AlterNativeUOM" onfocusout="AlterNativeUOMFun()"
	        <c:if test="${status eq 'Active' }"> readonly </c:if>
	        required>
	    ...
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "-1" class="form-control input-sm" id="Denominator"  required
	    ...
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "2" class="form-control input-sm" id="NetWeight" required
	    ...
	    <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "3" list="UnitWeightlist" class="form-control input-sm" maxlength="30"   value="${Unitdesc}" onchange="return unitweight();" id="UnitWeight" name="UnitWeight" placeholder="Unit Weight" autocomplete="off" onfocusout="UnitFun()" 
	    ...
	    <!-- <div class="form-group ">
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "-1" class="form-control input-sm" value="${volumeunit}" maxlength="16"  id="VolumeUnit"  placeholder="VolumeUnit" name="VolumeUnit" autocomplete="off" 
	        <c:if test="${status eq 'Active' }"> readonly </c:if>
	        >        
	      </div>
	    </div>-->
	    ...
	    <div class="form-group " id="id" <c:if test="${status eq 'Draft'  }"> style='display:none;' </c:if><c:if test="${appstus eq 'Rejected'}"> style='display:none;' </c:if> >
	      <label class="required control-label col-sm-4" id ="blockedreason" for="email">Blocked Reason</label>
	      <div class="col-sm-8 input-group">
	        <input type="text" tabindex = "5" <c:if test="${empty reason}" > readonly </c:if> class="form-control input-sm" maxlength="250"  onkeypress="return onlyAlphabets(event,this);"   id="reason" name="reason" value="${reason}" placeholder="Blocked Reason" autocomplete="off">        
	      </div>
	    </div>
   	 	</div>
   	 	 <div class="col-md-12">
			 <fieldset>
			 <legend class="w-auto">Plant Mapping View</legend> 
			 </fieldset> 
  		</div> 
   	 	<div class="col-md-6">
			<div class="form-group">
...
<%
   ...
   {
   %>
   <%System.out.println("heere you are");System.out.println(status);%>
     <div  class="col-md-1 col-md-offset-8"><input type="submit" name="Save" class="btn btn-primary form-control<c:if test="${status eq 'Active' }"> disabled </c:if>"  value="Save"/></div>
     <div class="col-md-1"><button type="submit" onclick="return check()" class="btn btn-primary" name="Submit" id="submit" value="Submit">Submit </button> </div>
	 <!-- <div class="col-md-1"><button type="submit" onclick = "return check();" class="btn btn-primary btn-md" name="Submit"  value="Submit">Submit</button></div> -->
