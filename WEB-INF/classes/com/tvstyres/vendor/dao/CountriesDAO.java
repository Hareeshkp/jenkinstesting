...
import com.tvstyres.vendor.model.Countries;
import com.tvstyres.vendor.model.Country;

public class CountriesDAO {

	public List<Countries> getCountrylist() throws SQLException, ClassNotFoundException
        ...
        List<Countries> countrylist = new ArrayList<>();
         try
         {
            ...
            while (result.next()) {
                ...
                Countries c=new Countries(countrycode, description);
