...
%>
	...
	VendorDAO vdo =new VendorDAO();
 	try
		{
		List<Vendor> listal = vdo.reviewlist(materialcode,vengrpdesc,userid_username);
...
<div class = "panel panel-primary">
	   <div class = "panel-heading">
	      <h3 class = "panel-title">Vendor Reviewer</h3>
	   </div>   
	   ...
	   <tbody>
		 <c:forEach items="${listall}" var="abcd">
		  <tr>
		    ...
		    <c:if test="${abcd.approval_status == 'Reviewed' || abcd.approval_status == 'Rejected'  }">disabled="disabled"</c:if>
