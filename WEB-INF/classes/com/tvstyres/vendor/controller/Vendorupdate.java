...
public class Vendorupdate extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ( modifiedby!=null) {
			...
			String actualqmsyscode = request.getParameter("actualqmsysid");
			String actualqmsysdesc = request.getParameter("qmsys");
			...
			v.setStatus(status);
            v.setModified_by(modifiedby);
            v.setBlock(block);
            v.setReason_for_block(reasonforblock);
            v.setReason_for_edit(reasonforedit);        
			...
			result = VendorDAO.Update(v);
			
			
			if (status.equals("Inactive")) {
				status = "Submit";
				v.setStatus(status);
				//int sss = VendorBasicDAO.insertaudits(cb);
			}
