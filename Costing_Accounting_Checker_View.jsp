<%@page import="com.tvs.accounting.AccountingDAO"%>
<%@page import="com.tvs.accounting.Accounting"%>
...
AccountingDAO ad=new AccountingDAO();

try
{
List<Accounting> listal=ad.alllist1();
...
<div class="table-responsive"><br>
	...
	<thead>
	   ...
	   <tbody>
	    ...
	    <tr>
	    <td><a  href='Costing_Accounting_Checker_Edit.jsp?id=${abcd.mdmcode}&amp;plant=${abcd.plantcode}'style="text-decoration:underline;"
