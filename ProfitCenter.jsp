...
if(request.getParameter("materialtype")!=null) 
{
    ...
    try
    {
        ...
        {
        %>   
          <option value="<%=rs.getString("Profit_Center")%>" data-id="<%=rs.getString("Profit_center_short_text_for_matchcode")%>"><%=rs.getString("Profit_center_short_text_for_matchcode")%></option>
