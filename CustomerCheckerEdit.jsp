...
function checkform()
{
	  ...
	  $("#deliverypriorityid").prop("required",false);
	  $("#shipping").prop("required",false);
	  $("#shippingid").prop("required",false);
	  $("#pricegroup").prop("required",false);
	  $("#pricegroupid").prop("required",false);
	  $("#price").prop("required",false);
	  $("#priceid").prop("required",false);
	  $("#salesoffice").prop("required",false);
	  $("#salesofficeid").prop("required",false);
	  $("#salesgroup").prop("required",false);
	  $("#salesgroupid").prop("required",false);
	  ...
	  $("#custclassid").prop("required",false);
	  $("#paymentterm").prop("required",false);
	  $("#paymenttermid").prop("required",false);
	  $("#activitycode").prop("required",false);
	  $("#activitycodeid").prop("required",false);
...
<form action="customerApproval"  method="post" onsubmit="return mygst();return validatepinCode();return reply_click()">
    ...
    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
				 <input type="text" readonly  onkeypress="return onlyAddress(event,this);"  class="form-control input-sm input_text" maxlength="60" name="mdmcustomercode"   value="${mdmcustomercode}"  required  placeholder="Customer Code"  autocomplete="off" >
		      </div>
		    </div>
	    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      	<input type="text"  class="form-control input-sm input_text" disabled  readonly  maxlength="10" name="sapcustomercode"   id="sapcustomercode" value="${sap_customer_code}"   placeholder="SAP Customer Code"                                    placeholder="MDM Code"  required autocomplete="off"  >
		    ...
		    <div class="row">
   		  ...
   		  <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="customergrouplist" readonly  disabled required class=" form-control input-sm input_text" name="customergroup" <c:if test="${status eq 'Active' }"> readonly </c:if>  id="customergroup"  value="${customer_group_desc}"  onfocusout="customergroupchange()" onchange="return Customergroup();"   placeholder="Customer Group"  autocomplete="off"  >
        ...
        <input type="hidden" name="customergroupid" id="customergroupid" > 	
		    ...
		    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="titlelist" required disabled class=" form-control input-sm input_text" name="title" <c:if test="${status eq 'Active' }"> readonly </c:if>  id="title"  value="${title_desc}"    placeholder="Title"  onchange="return Title();" autocomplete="off"  >
        ...
        <input type="hidden" name="titleid" id="titleid" value="${title_code}" > 
		    ...
		    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		       		      <input type="text" readonly disabled   onkeypress="return namevalidate(event,this);" value="${name}" <c:if test="${status eq 'Active' }"> readonly </c:if>  class="form-control input-sm "  maxlength="40" name="name"  placeholder="Name"   id="name" required autocomplete="off">
		      </div>
		    </div>
	 ...
	 <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		       		      <input type="text" disabled onkeypress="return namevalidate(event,this);"  class="form-control input-sm " value="${name2}"   name="name2"  placeholder="Name2"   id="name2"  autocomplete="off">
 ...
 <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		       		      <input type="text" disabled  class="required form-control input-sm " onkeypress="return onlyAlphabets(event,this);" value="${legalname}"  maxlength="40" name="legalname"  placeholder="Legal Name"   id="legalname"  autocomplete="off">
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="countrylist" required disabled class=" form-control input-sm input_text" name="country"  id="country" <c:if test="${status eq 'Active' }"> readonly </c:if>  value="${country_desc}"  onfocusout="countryy()"  onchange="return Country()"  placeholder="Country"  autocomplete="off"  >
 ...
 <div class="row">
  <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input  list="statelist" disabled class=" form-control input-sm input_text" name="state"  id="state" maxlength="50" value="${state_desc}"    placeholder="State"  onchange="return Statecheck();" autocomplete="off"  >
 ...
 <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input type="text" disabled class="form-control input-sm input_text" onkeypress="return onlyAddress(event,this);" name="houseno"  maxlength="10" value="${houseno}"  id="houseno"   placeholder="House No"   autocomplete="off" >
...
<div class="row">
 ...
 <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input type="text" readonly disabled  class="form-control input-sm input_text" onkeypress="return onlyAddress(event,this);" name="Street"  maxlength="60"  id="street" value="${street}"  placeholder="Street" required  autocomplete="off" >
		    ...
		    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
				<input type="text" disabled onkeypress="return onlyAddress(event,this);"  class="form-control input-sm input_text"  maxlength="40" name="street1"  id="street1" value="${street1}"   placeholder="Street1" autocomplete="off" >
...
<div class="row">
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
				<input type="text" disabled readonly   class="form-control input-sm input_text"  maxlength="10" name="pincode"  id="pincode"  value="${pincode}"  placeholder="Pin Code" required autocomplete="off" >
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
				     <input type="text" disabled readonly  onkeypress="return onlyAlphabets(event,this);" class="form-control input-sm input_text" value="${city}"  name="city" maxlength="35" required  id="city"   placeholder="City"  required autocomplete="off" >
		      </div>
		    </div>
		    </div>
 ...
 <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     		        				       		      <input type="text" disabled  onkeypress="return isNumber(event)"  class="form-control input-sm " value="${telephone_no}"   maxlength="15" name="telno"  placeholder="Telephone No"   id="telno"  autocomplete="off">
 ...
 <div class="row">
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		       		      <input type="text" disabled  onkeypress="return isNumber(event)" value="${mobile_no}"  class="form-control input-sm "  maxlength="15" name="mobileno"  placeholder="Mobile"   id="mobileno"  autocomplete="off">
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input type="email" disabled  title="please enter a valid emailid"  pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}"  value="${emailid}"  class="form-control input-sm "  maxlength="241" name="mailid"  placeholder="Email Id"   id="mailid"  autocomplete="off">
		      </div>
		    </div>
		    </div>
  ...
  <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input  list="distchannellist" disabled <c:if test="${status eq 'Active' }"> readonly </c:if> required class=" form-control input-sm input_text" name="distchannel" value="${distchannel_desc}"  id="distchannel"  onfocusout="DistFun()" onchange="return distchannelcheck();"   placeholder="Distribution Channel"  autocomplete="off"  >
        ...
        <input type="hidden" name="distchannelid" id="distchannelid" value="${distchannel_code}" > 
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="divisionlist" disabled <c:if test="${status eq 'Active' }"> readonly </c:if> required class=" form-control input-sm input_text" name="division"  id="division" onchange="return divisioncheck();" value="${division_desc}" maxlength="50"  onfocusout="DivisionFun()"   placeholder="Division"  autocomplete="off"  >
        ...
        <div class="row">
         <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="salesdistrictlist" disabled  required class=" form-control input-sm input_text" name="salesdistrict" value="${salesdict_desc}"  id="salesdistrict"   onfocusout="SalesDistFun()"  onchange="return salesdistcheck();"  placeholder="Sales District"  autocomplete="off"  >
     ...
     <div class="row">
       ...
       <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="custpricelist" required disabled class=" form-control input-sm input_text" name="custprice"  id="custprice" value="${custpriceproc_desc}"  onfocusout="CustpriceFun()" onchange="return custpricecheck();"   placeholder="Cust. Price Procedure"  autocomplete="off"  >
        ...
        <input type="hidden" name="custpriceid" id="custpriceid" value="${custpriceproc_code}" > 
			 ...
			 <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="customerstatslist" required disabled class=" form-control input-sm input_text" name="customerstats" value="${custstatsgrp_desc}"  id="customerstats" maxlength="50"  onfocusout="CuststatsFun()"  onchange="return custstatcheck();" placeholder="Customer Stats. Group"  autocomplete="off"  >
     ...
     <div class="row">
       <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="incotermlist" required disabled class=" form-control input-sm input_text" name="incoterm"  id="incoterm"  onfocusout="IncotermFun()" value="${incoterm_desc}"  onchange="return incotermcheck();" placeholder="Incoterm"  autocomplete="off"  >
        ...
        <input type="hidden" name="incotermid" id="incotermid" value="${incoterm_code}" > 
		    ...
		    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input  class=" form-control input-sm input_text" disabled name="incolocation1" value="${inco_location1}"  id="incolocation1" maxlength="16"    placeholder="Inco. Location1" onfocusout="statechange()" onchange="return Statecheck();" autocomplete="off"  >
     ...
     <div class="row">
      <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="deliveryprioritylist" required  disabled class=" form-control input-sm input_text" name="deliverypriority" value="${delivery_priority_desc}"  id="deliverypriority"  onfocusout="DeliveryFun()" onchange="return deliverycheck();"  placeholder="Delivery Priority"  autocomplete="off"  >
        ...
        <input type="hidden" name="deliverypriorityid" id="deliverypriorityid" value="${delivery_priority_code}" > 
		    ...
		    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="shippinglist" required disabled class=" form-control input-sm input_text" value="${shipping_cond_desc}" name="shipping"  id="shipping" maxlength="50" onfocusout="ShippingFun()"  onchange="return shippingcheck();"  placeholder="Shipping Condition"  autocomplete="off"  >
     ...
     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="pricegrouplist" required  disabled class=" form-control input-sm input_text" value="${pricegrp_desc}" name="pricegroup"  id="pricegroup"  onfocusout="PricegroupFun()" onchange="return pricegroupcheck();"    placeholder="Price Group"  autocomplete="off"  >
        ...
        <input type="hidden" name="pricegroupid" id="pricegroupid" value="${pricegrp_code}" > 
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="pricelist"  disabled  class=" form-control input-sm input_text" name="price"  id="price" value="${pricelist_desc}"   maxlength="50" onfocusout="PricelistFun()"  onchange="return pricelistcheck();"  placeholder="Price List"  autocomplete="off"  >
     ...
     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="salesofficelist" required disabled  value="${salesoffice_desc}" class=" form-control input-sm input_text" name="salesoffice"  id="salesoffice"  onfocusout="SalesOfficeFun()"  onchange="return salesofficecheck();"  placeholder="Sales Office"  autocomplete="off"  >
        ...
        <input type="hidden" name="salesofficeid" id="salesofficeid" value="${salesoffice_code}" > 
		      ...
		      <div class="col-sm-8 input-group">
		     <input  list="salesgrouplist" disabled  <c:if test="${status eq 'Active' }"> readonly </c:if> required class=" form-control input-sm input_text" name="salesgroup" value="${salesoffice_desc}"  id="salesgroup" maxlength="50"  onchange="return salesgroupcheck();"   placeholder="Sales Group"  onfocusout="SalesgroupFun()" autocomplete="off"  >
    ...
    <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
				     <input type="text" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  maxlength="30" value="${panno}" class="form-control input-sm input_text" onkeypress="" name="panno"  id="panno"   placeholder="PAN No"   autocomplete="off" >
		     ...
		     <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		    <input type="text" disabled <c:if test="${status eq 'Active' }"> readonly </c:if> value="${gstno}" pattern="[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[0-9A-Z]{3}" title="Please enter valid GST No"  onkeypress="return onlyAlphanumeric(event,this);"  class="form-control input-sm "  maxlength="15" name="gstno"  placeholder="GST No"   id="gstno"  autocomplete="off">
     ...
     <div class="form-group col-md-6">
      ...
      <div class="col-sm-8 input-group">
   		...
   		<div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
          <select class="form-control input-sm" disabled  id="glcode" readonly  name="glcode" >		      
		      </select>	
		      </div>
		    </div>
    </div>
      ...
      <div class="row">
     <div class="form-group col-md-6">
		      <label class="control-label col-sm-4" for="name">Customer Classific</label>
		      <div class="col-sm-8 input-group">
		       		      <input type="text" disabled list="custclasslist" value="${custemer_clasific_desc}"  class="form-control input-sm " onkeypress="return onlyAlphabets(event,this);"   name="custclass"  placeholder="Customer Classific" onfocusout="CustomerClassificFun()"   id="custclass"  onchange="return customerclassificcheck();" autocomplete="off">
        ...
        <input type="hidden" name="custclassid" id="custclassid" value="${custemer_clasific_code}" > 
		    ...
		    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input  list="activitycodelist" disabled class=" form-control input-sm input_text" name="activitycode"  id="activitycode" maxlength="50"  value="${activity_code_desc}"   placeholder="Activity Code" onfocusout="ActivityCodeFun()" onchange="return activitycodecheck();" autocomplete="off"  >
     ...
     <div class="form-group col-md-6">
        ...
        <input type="hidden" name="currencyid" id="currencyid" value="${currency_code}" > 
		    ...
		    <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
		      <input type="text" list="paymenttermlist" disabled class="form-control input-sm input_text"  value="${payment_term_desc}" name="paymentterm"    id="paymentterm" onchange="return paymenttermcheck();"  onfocusout="PaymentTermFun()"  placeholder="Payment Term"   autocomplete="off" >
...
<span class="glyphicon glyphicon-search form-control-feedback"></span>
  ...
  <div class="row">
		   <div class="form-group col-md-6">
		      ...
		      <div class="col-sm-8 input-group">
 <select class="form-control input-sm " disabled required <c:if test="${status eq 'Active' }"> readonly </c:if>  id="revusername"   name="revusername" >	
 <option value="" > Select </option>	
  <c:forEach items="${listcustrev}" var="c">  		            
		            <option value="${c.reviewerusername}" 
		            
		            <c:if test="${c.reviewerusername eq  reviewerusername}"> selected="selected"</c:if>
...
<div class="form-group col-md-6"  <c:if test="${status eq 'Draft'}" > style='display:none;' </c:if> <c:if test="${approvalstatus eq 'Rejected'}"> style='display:none;' </c:if><c:if test="${status eq 'Inactive' and version < 1}"> style='display:none;' </c:if>>
		      ...
		      <div class="col-sm-8 input-group">
		      		<input type="text" 
		      		 maxlength="40" disabled <c:if test="${access eq 'Read'}" > disabled </c:if> <c:if test="${status eq 'Active'}" > required </c:if> name="reasonforedit" class="form-control input-sm"  autocomplete="off" value="${reasonforedit}" placeholder="Reason for edit" id="reasonforedit" >                   	   
		      </div>
		    </div>
</div>
	    ...
	    >
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" disabled <c:if test="${empty reason_for_block}" > readonly </c:if> <c:if test="${access eq 'Read'}" > disabled </c:if> class="form-control input-sm" maxlength="40"  value="${reason_for_block}"  id="reasonforblock" name="reasonforblock" placeholder="Reason for block" autocomplete="off"
	    ...
	    <div <c:if test="${access eq 'Approval'}" > style='display:none;' </c:if>  class="col-md-2 col-md-offset-8"><input type="submit"  class="btn btn-primary form-control"  name="Review" value="Approve"/></div>
  	...
  	<br>
	      ...
	      <div class="col-sm-8 input-group">
	        <input type="text" maxlength="50" class="form-control input-sm" id="rjcomments" name="rjcomments"  autocomplete="off" >        
	      </div>
	    </div>
	...
	<div class="row" style="margin-top:2%;display:none;" id="attribute">
		...
		<div class = "panel panel-primary">
   		...
   		<div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="continentlist" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="continent"  id="continent" value="${continent_desc}" onfocusout="ContinentFun()"  placeholder="Continent" onchange="return continentcheck();"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute2list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="attribute2"  id="attribute2"  placeholder="Attribute2" onfocusout="Attribute2Fun()" onchange="return attribute2check()" value="${attribute2_desc}"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute3list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if> class=" form-control input-sm input_text" name="attribute3"  id="attribute3"  onfocusout="Attribute3Fun()" onchange="return attribute3check()" placeholder="Attribute3" value="${attribute3_desc}"   autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		     ...
		     <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute4list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="attribute4"  id="attribute4"  placeholder="Attribute4" onfocusout="Attribute4Fun()" onchange="return attribute4check()" value="${attribute4_desc}"   autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		     ...
		     <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute5list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="attribute5"  id="attribute5"  placeholder="Attribute5" onfocusout="Attribute5Fun()" onchange="return attribute5check()" value="${attribute5_desc}"   autocomplete="off"  >
	  ...
	  <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute6list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="attribute6"  id="attribute6"  placeholder="Attribute6" onfocusout="Attribute6Fun()" onchange="return attribute6check()" value="${attribute6_desc}"   autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		     ...
		     <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute7list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if> class=" form-control input-sm input_text" name="attribute7"  id="attribute7"  placeholder="Attribute7" onfocusout="Attribute7Fun()" value="${attribute7_desc}"  onchange="return attribute7check()"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute8list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="attribute8"  id="attribute8"  placeholder="Attribute8" onfocusout="Attribute8Fun()" onchange="return attribute8check()" value="${attribute8_desc}"   autocomplete="off"  >
	   ...
	   <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute9list" disabled  <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="attribute9"  id="attribute9"  placeholder="Attribute9" onfocusout="Attribute9Fun()" onchange="return attribute9check()" value="${attribute9_desc}"   autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
            <input  list="attribute10list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="attribute10"  id="attribute10"  placeholder="Attribute10" onfocusout="Attribute10Fun()" onchange="return attribute10check()" value="${attribute10_desc}"   autocomplete="off"  >
	  ...
	  <div class=form-group>
	  <div class="col-md-12	">
		     <div class="col-md-3"><input type="button" disabled <c:if test="${status eq 'Active' }"> disabled </c:if> onclick="ClearBackAttribute()"  class="btn btn-primary form-control" name="back"  value="Clear"/> </div>
...
<div class="row" style="margin-top:2%;display:none;"  id="congroup">
		...
		<div class = "panel panel-primary">
   		...
   		<div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="conditiongroup1list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="conditiongroup1"  id="conditiongroup1"  placeholder="Condition Group1" value="${condition_group1_desc}" onfocusout="Congrp1Fun()" onchange="return condgroup1check()"  autocomplete="off"  >
		   ...
		   <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="conditiongroup2list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="conditiongroup2"  id="conditiongroup2" value="${condition_group2_desc}"  placeholder="Condition Group2" onfocusout="Congrp2Fun()" onchange="return condgroup2check()"   autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="conditiongroup3list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="conditiongroup3"  id="conditiongroup3"  placeholder="Condition Group3" value="${condition_group3_desc}" onfocusout="Congrp3Fun()" onchange="return condgroup3check()"   autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="conditiongroup4list" disabled  <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="conditiongroup4"  id="conditiongroup4"  placeholder="Condition Group4" onfocusout="Congrp4Fun()" onchange="return condgroup4check()" value="${condition_group4_desc}"   autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="conditiongroup5list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="conditiongroup5"  id="conditiongroup5"  placeholder="Condition Group5"  onfocusout="Congrp5Fun()"  value="${condition_group5_desc}" onchange="return condgroup5check()"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		     ...
		     <div class="col-md-3"><input type="button" disabled <c:if test="${status eq 'Active' }"> disabled </c:if> class="btn btn-primary form-control" name="Submit" onclick="Clearcongroup()"  value="Clear"/> </div>
...
<div class="row" style="margin-top:2%;display:none;"  id="cggroup">
		...
		<div class = "panel panel-primary">
   		...
   		<div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="customergroup1list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="customergroup1"  id="customergroup1" value="${customer_group1_desc}"  placeholder="Customer Group1" onfocusout="Custgrp1Fun()" onchange="return custgroup1check()"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="customergroup2list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="customergroup2"  id="customergroup2" value="${customer_group2_desc}"  onfocusout="Custgrp2Fun()" placeholder="Customer Group2" onchange="return custgroup2check()"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="customergroup3list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="customergroup3"  id="customergroup3"  placeholder="Customer Group3" value="${customer_group3_desc}" onfocusout="Custgrp3Fun()" onchange="return custgroup3check()"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		     ...
		     <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="customergroup4list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="customergroup4"  id="customergroup4"  onchange="return custgroup4check()" value="${customer_group4_desc}" placeholder="Customer Group4" onfocusout="Custgrp4Fun()"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		    ...
		    <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="customergroup5list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="customergroup5"  id="customergroup5"  placeholder="Customer Group5" onfocusout="Custgrp5Fun()"  value="${customer_group5_desc}" onchange="return custgroup5check()"  autocomplete="off"  >
	  ...
	  <div class="form-group ">
		      ...
		      <div class="col-sm-8 input-group">
		       <input  list="customergroup6list" disabled <c:if test="${status eq 'Active' }"> readonly </c:if>  class=" form-control input-sm input_text" name="customergroup6"  id="customergroup6"  placeholder="Customer Group6" onfocusout="Custgrp6Fun()" onchange="return custgroup6check()" value="${customer_group6_desc}"  autocomplete="off"  >
		   ...
		   <span class="glyphicon glyphicon-search form-control-feedback"></span>
		     ...
		     <div class="col-md-3"><input type="button" disabled <c:if test="${status eq 'Active' }"> disabled </c:if>  class="btn btn-primary form-control" onclick="Clearcggroup()" name="Submit"  value="Clear"/> </div>
