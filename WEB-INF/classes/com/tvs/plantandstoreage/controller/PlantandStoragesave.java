...
import com.tvs.plantandstorage.CheckDuplicateDAO;
import com.tvs.plantandstorage.PlantandStorage;
import com.tvs.plantandstorage.PlantandStorageDAO;



@WebServlet("/Plantandstoragesave")
public class PlantandStoragesave extends HttpServlet 
...
public void doPost(HttpServletRequest request, HttpServletResponse response)  
	...
	String materialtypedesc=materialtypes[0];  //Material type Description
	...
	else
	{
	            ...
	            int status=PlantandStorageDAO.insert(p);
	            if(stus.equals("Inactive") )
	            {
	            	stus="Submit";
	            	p.setStatus(stus);
	            	int sss=PlantandStorageDAO.insertaudit(p);
	            }
