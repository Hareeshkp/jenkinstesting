...
@WebServlet("/MrpUpdate")
public class MrpUpdate extends HttpServlet 
...
public void doPost(HttpServletRequest request, HttpServletResponse response)  
	...
	if (modifiedby != null )
	{
		...
		m.setReasonforedit(reasonforedit);
		m.setApprovalprocess("Pending");
		m.setReasonforrejection(null);
		int statu=MrpDAO.Update(m); 
		if(stus.equals("Inactive") )
		{
			stus="Submit";
			m.setStatus(stus);
		    int sss=MrpDAO.insertaudits(m);
