...
try
{
List<Purchase> listal = pd.alllist1();
	...
	<thead>
	   ...
	   <tbody>
	   	<c:forEach items="${listall}" var="abcd">		 
	    	<tr>
	    		<td><a  href='Purchasing_Plant_Storage_Checker_Edit.jsp?id=${abcd.mdmcode}&amp;plant=${abcd.plantcode}' style="text-decoration:underline;"
