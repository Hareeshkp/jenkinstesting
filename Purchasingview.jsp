...
try
{
List<Purchase> listal = pd.UserList1(username,plantv,mattyp,status,apvstatus,version);
	...
	<thead>	  
	   ...
	   <tbody>
	   	<c:forEach items="${listall}" var="abcd">		 
	    	<tr>
	    		<td><a  href='Purchase_Plant_Storage_Edit.jsp?id=${abcd.mdmcode}&amp;plant=${abcd.plantcode}' style="text-decoration:underline;"
